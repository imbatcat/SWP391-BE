...
DROP TABLE Appointment
	...
	CREATE TABLE Drug(
		drug_id CHAR(10) PRIMARY KEY NOT NULL,
	...
	CREATE TABLE Prescription(
		prescription_id CHAR(10) PRIMARY KEY NOT NULL,
	...
	CREATE TABLE PrescriptionDetail(
		...
		prescription_id CHAR(10) FOREIGN KEY REFERENCES Prescription(prescription_id),
		drug_id CHAR(10) FOREIGN KEY REFERENCES Drug(drug_id),
	)
