...
CREATE TABLE [Appointments] (
    [AppointmentId] char(11) NOT NULL,
    [AppointmentDate] date NOT NULL,
    [AppointmentType] nvarchar(50) NOT NULL,
    [AppointmentNotes] nvarchar(200) NULL,
    [BookingPrice] float NOT NULL,
    [AccountId] char(11) NOT NULL,
    [PetId] char(11) NOT NULL,
    [VeterinarianAccountId] char(11) NOT NULL,
...
CREATE TABLE [BookingPayments] (
    ...
    CONSTRAINT [FK_BookingPayments_Appointments_AppointmentId] FOREIGN KEY ([AppointmentId]) REFERENCES [Appointments] ([AppointmentId]) ON DELETE NO ACTION
);
GO
...
CREATE TABLE [MedicalRecords] (
    [MedicalRecordId] char(11) NOT NULL,
...
CREATE TABLE [ServiceOrders] (
    [ServiceOrderId] char(11) NOT NULL,
    [Price] float NOT NULL,
...
CREATE TABLE [ServicePayments] (
    [ServicePaymentId] char(11) NOT NULL,
    [ServicePrice] float NOT NULL,
    [PaymentDate] date NOT NULL,
...
VALUES (N'20240524160419_db', N'8.0.5');
GO
